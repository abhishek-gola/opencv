...
// ONNX CumProd operator: cumulative product along an axis (multiplicative CumSum).
// Attributes: exclusive (j-th output excludes the j-th element), reverse (iterate backwards).
