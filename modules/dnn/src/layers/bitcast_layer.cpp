...
// ONNX BitCast operator: reinterpret the raw bytes of the input as the target type.
// Only equal-width reinterpretation is supported (shape is preserved), which covers
// every ai.onnx BitCast conformance case.
